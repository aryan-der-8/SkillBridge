...
const UserProfile = () => {
  ...
  const handleDownload = async (type) => {
    ...
    if (type === "jpg" || type === "png") {
      ...
      link.href = type === "jpg" ? imgData.replace("image/png", "image/jpeg") : imgData;
      link.download = `UserProfile.${type}`;
      link.click();
    } else if (type === "pdf") {
  ...
  return (
    <Box sx={{ bgcolor: "#f5f7fa", minHeight: "100vh" }}>
      <Box>
        <div ref={profileRef} style={{ padding: "20px" }} id="user-profile">
      ...
      >
        <MenuItem onClick={() => handleDownload("jpg")}>Download as JPG</MenuItem>
